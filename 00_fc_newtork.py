...
if __name__ == '__main__':
    ...
    relative_time_dfa = stats_dfa['total_time']/stats_bp['total_time']

    plt.title('Loss vs time')
    plt.xlabel('time')
    plt.ylabel('loss')
    plt.plot(np.arange(len(stats_dfa['train_loss'])) * relative_time_dfa, stats_dfa['train_loss'])
    plt.plot(np.asarray(stats_dfa['valid_step']) * relative_time_dfa, stats_dfa['valid_loss'])
    plt.plot(np.arange(len(stats_bp['train_loss'])), stats_bp['train_loss'])
    plt.plot(stats_bp['valid_step'], stats_bp['valid_loss'])
    plt.legend(['train loss dfa', 'validation loss dfa', 'train loss bp', 'validation loss bp'], loc='upper right')
    plt.grid(True)
    ...
    plt.xlabel('time')
    plt.ylabel('accuracy')
    plt.plot(np.arange(len(stats_dfa['train_accuracy'])) * relative_time_dfa, stats_dfa['train_accuracy'])
    plt.plot(np.asarray(stats_dfa['valid_step']) * relative_time_dfa, stats_dfa['valid_accuracy'])
    plt.plot(np.arange(len(stats_bp['train_accuracy'])), stats_bp['train_accuracy'])
    plt.plot(stats_bp['valid_step'], stats_bp['valid_accuracy'])
    plt.legend(['train accuracy dfa', 'validation accuracy dfa', 'train accuracy bp', 'validation accuracy bp'], loc='lower right')
    plt.grid(True)
